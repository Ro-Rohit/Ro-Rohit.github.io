        ...
        <>
            {socialLinksData.map((element, idx) => (
                <a
                    target="_blank"
                    key={idx}
                    onMouseEnter={() => bleeps.clickLink?.play()}
                    href={element.href}
                ...
                >
                    ...
                    <h6
                        ...
                        className="hidden sm:block font-secondary  capitalize  text-[15px]"
                    >
                        {element.text}
                    </h6>
                </a>
...
const Header = ({ active, isScrolled }) => {
    ...
    return (
        <>
            <header
                className={`${
                    isScrolled ? ' backdrop-blur-[4px]' : ' backdrop-blur-0'
                ...
                >
                    ...
                    >
                        <Animated
                            ...
                            as="div"
                            className="flex gap-x-5 z-10 relative items-center"
                        >
                            <a
                            ...
                            >
                                ...
                                <Animator active={active}>
                                    <img
                                        className="object-cover contrast-[102%] brightness-110   -translate-y-1   h-full"
                                        src={homeData.avator}
                                        alt=""
                                    />
                                </Animator>
                            ...
                            <Animator active={active}>
                                <Text
                                    ...
                                    as="a"
                                    href="/"
                                    className="font-primary font-normal  uppercase text-[23px]"
                                    style={{
                                        color: theme.colors.primary.text(1),
                                        textShadow:
                                            '0 0 4px rgba(180,249,251,0.65)',
                                    }}
                                >
                                    Rohit Singh
                                </Text>
                                <Animator active={true}>
                                    ...
                                    >
                                        <svg
                                            ...
                                            className="size-6 mb-0.5 translate-y-0.5 -rotate-45"
                        ...
                        <Animator duration={{ enter: 1.2 }}>
                            <Animated
                                ...
                                className="hidden sm:flex flex-wrap z-10 relative  justify-center mt-2 mb-4 gap-x-6 gap-y-1 items-center"
                            >
                                <SocialLinks />
                            </Animated>
                        </Animator>
